...
const DetailProduct = () => {
  ...
  const imageList = [
    ...
    "https://www.svgrepo.com/show/387193/clothes-windbreaker.svg",
    "https://www.svgrepo.com/show/387191/clothes-sweater.svg",
    "https://www.svgrepo.com/show/387188/clothes-suit.svg",
    "https://www.svgrepo.com/show/387179/clothes-crew-neck.svg",
  ];
  ...
  const price = 20.0;
  const colorList = ["black", "blue", "green", "brown"];
      ...
      <div className="w-full h-auto flex mt-32">
        ...
        <div className="h-[482px] w-auto">
          <div className="w-[367px] h-[460px]">
            ...
            <div className="flex gap-[10.5px] overflow-x-auto">
        ...
        <div className="h-[482px] w-auto ml-7">
          ...
          <p className="text-[#9B9B9B] text-[16px] font-medium">Zalora Cloth</p>
          {/* Ratings */}
