export default function SearchBar() {
	return (
		<div className='w-[507px] relative bg-white border border-[#8E8E93] rounded-full overflow-hidden'>
			<input
				type='text'
				name='search'
				className='w-full h-full py-3 px-5 focus:outline-none placeholder:text-[#9B9B9B]'
				placeholder='Search'
			/>
			<svg
				width='18'
