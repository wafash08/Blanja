    ...
    <div className='w-[100%] max-w-[850px] max-lg:w-[100%] h-auto bg-[#F5F5F5]'>
        ...
        <div className='w-[100%] bg-white px-6 py-8  rounded-[4px]'>
            ...
            <div className='w-[348px] max-lg:w-[100%] mb-10'>
                <InputField type='text' name="stock" label="Stock" value={formProduct.stock} placeholder="Ex: 12" onChange={handleChangeInput} />
            </div>
            <div className='w-[348px] max-lg:w-[100%] mb-10'>
        ...
        <p className='text-[#D4D4D4] text-[12px] pt-4 font-normal'>* image must contain less than 2 MB</p>
        <p className='text-[#D4D4D4] text-[12px] pb-4 font-normal'>* image must contain .png|.jpg|.jpeg</p>
            <div className='w-[100%] max-lg:w-[100%] h-auto px-4 py-8 rounded-[4px] outline-1 outline-dashed outline-[#D4D4D4] flex flex-col items-center'>
                ...
                <ul className='flex items-center gap-5 whitespace-nowrap'>
                    {formProduct.images.map((image, index) => (
                        ...
                        className={`relative bg-[image:var(--image-product)] bg-cover bg-center rounded-md whitespace-nowrap ${index === 0 ? 'w-[190px] h-[190px]' : 'w-[120px] h-[120px]'}`}
                      >
        ...
        <div className='w-full h-auto flex justify-end mt-10'>
            <div className='w-[128px]'>
                <Button onClick={handleUpdateProduct}>Jual</Button>
            </div>
        </div>
        {/* Button submit */}
    </div>
